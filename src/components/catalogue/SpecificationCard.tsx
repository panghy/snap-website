  ...
  return (
    <div className={styles.specificationCard}>
      <div className={styles.cardHeader}>
        <h3 className={styles.specName}>{specification.name}</h3>
        <span className={styles.versionBadge}>v{specification.version}</span>
      </div>

      <p className={styles.specDescription}>{specification.description}</p>

      <div className={styles.specMeta}>
        <a
          href={specification.repository}
          target="_blank"
      ...
      {implementations.length === 0 && (
        <div className={styles.noImplementations}>
          <p>No implementations yet</p>
          <p className={styles.encouragement}>
            Be the first to implement this specification!
          </p>
        </div>
      )}
    </div>
